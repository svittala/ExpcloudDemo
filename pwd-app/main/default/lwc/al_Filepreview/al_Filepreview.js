...
import retriveFiles from '@salesforce/apex/al_Filepreview.retriveFiles';
        ...
        if(data) {
            ...
            const dataList = data.map((item) => {
              ...
              if(item.FileExtension === 'docx')
                ...
                url =  '/sfc/servlet.shepherd/version/renditionDownload?rendition=PDF&versionId='+item.Id+'&operationContext=CHATTER';
              return {
                ...item,
                src: url,
