...
const COLUMNS = [
  ...
  { name: FLD_BLOOD_LEAD_LEVEL.fieldApiName },
  { name: FLD_INFLUENZA_TYPE.fieldApiName },
...
const TITLE = 'Previously Entered Risk-Based Lab Tests';

export default class UacPrevRiskBasedTestTable extends LightningElement {
  ...
  get filter() {
    let queryFilter = `RecordType.DeveloperName='${LBL_RECORD_TYPE_RISK_BASED_LAB_TEST}'`;
    queryFilter +=
